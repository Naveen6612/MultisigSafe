...
export default function Home() {
  ...
  const WalletCreatedEvent = prepareEvent({
    signature:
      "event WalletCreated(address wallet, address creator, uint256 index, address[] owners, uint256 numConfirmationsRequired)",
  });
              ...
              <TransactionButton
                transaction={() =>
                  prepareContractCall({
                    contract,
                    method:
                      "function createWallet(address[] _owners, uint256 _numConfirmationsRequired)",
